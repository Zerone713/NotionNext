...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '零', // 您的昵称 例如 tangly1024
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '零点', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个不正经的设计师🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.zeroblogs.cc', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客，零点，暖通，二次开发，Python', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'zerone722@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/319776433', // B站主页
